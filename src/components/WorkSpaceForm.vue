...
import { workSpaceRules } from '@/rules/workspaceRules'
...
<template>
  <el-dialog v-model="dialogVisible" title="Add Workspace" width="500" destroy-on-close>
    <el-form
      ref="formRef"
      :model="form"
      label-width="auto"
      :rules="workSpaceRules(form)"
